...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=Path(__file__).resolve().parents[1] / "generated" / "bindings.lisp", help="Output Lisp file.")
...
def main() -> int:
    args = parse_args()
    try:
        generated = generate_bindings(args.include_dir)
